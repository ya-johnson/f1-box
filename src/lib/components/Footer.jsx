    ...
    <footer className="bg-white dark:bg-neutral-900 py-14 mt-10 brd border-t">
      <div className="container flex justify-between md:flex-col">
        <div className="flex flex-col space-y-1">
          <Link href="/"><a className="text-3xl font-bold mb-2 hover:text-amber-400">F1 box</a></Link>
          ...
          <Link href={config.API_URL}><a target='_blank' className="text-lg font-semibold hover:text-amber-400">Ergast F1 API</a></Link>
